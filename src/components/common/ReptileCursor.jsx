...
const ReptileCursor = () => {
    ...
    useEffect(() => {
        ...
        // --- PHYSICS CLASSES FROM script (1).js ---
        ...
        class Segment {
            ...
            draw(iter) {
                ...
                ctx.strokeStyle = '#1152d4'; // Brand Blue
                ctx.lineWidth = 2;
                ctx.stroke();
                if (iter) {
                    for (var i = 0; i < this.children.length; i++) {
        ...
        const s = 1.0; // Average base scale
        const legNum = 6; // Average leg count
        const tail = 24; // Average tail length

        const critter = new Creature(
            window.innerWidth / 2,
            window.innerHeight / 2,
            0,
            s * 10, // Increased acceleration for faster speed
            s * 2,
            0.5,
            16,
            0.5,
        ...
        const animate = () => {
            ...
            critter.follow(mouseRef.current.x, mouseRef.current.y);
